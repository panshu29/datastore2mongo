...
program.version('0.0.9', '-v, --vers', 'current version')
      ...
      .on('--help', function () {
            ...
            console.log(colors.brightBlue(' To auto migrate single kind: ')+colors.brightYellow('$ datastore2mongo -d <namespace> -c <kind> -i <projectId> -h <host> -p <port> -a y'));
            console.log(colors.brightBlue(' To auto migrate all kinds of a namespace: ')+colors.brightYellow('$ datastore2mongo  -d <namespace> -i <projectId> -c all -h <host> -p <port> -a y '));
